...
function getAllNames() public view returns (string[] memory) {
  ...
  constructor(string memory _tld) payable ERC721("Performer Registry Name Service", "PRNS") {
    tld = _tld;
...
_setTokenURI(newDomainId, "ipfs://QmWcECd1rtuqDrkwWdeeorVVG16ZQGaoq2W2gdEPm9EkBg")
