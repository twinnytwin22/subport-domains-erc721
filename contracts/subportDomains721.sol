...
contract subportDomains721 is ERC721URIStorage {
    ...
    function register(
        ...
        // Check if the role parameter matches one of the allowed roles
        if (
            ...
            revert("Role can only be set to creator or collector");
        }
        ...
        if (
            ...
            revert("Admin role can only be assigned by owner");
        }
        ...
        _setTokenURI(
            newRecordId,
            "ipfs://QmWcECd1rtuqDrkwWdeeorVVG16ZQGaoq2W2gdEPm9EkBg"
        );
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        require(newOwner != address(0), "Invalid address: New owner address cannot be zero");
